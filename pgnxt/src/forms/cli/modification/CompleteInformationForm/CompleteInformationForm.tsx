...
import { deserializeCliModifyCollection } from '../../../../helpers/mappers/deserializers/cli/modification/deserialize';
...
const CompleteInformationForm: React.FC = () => {
  ...
  >(`${ApiUrls.cli.modification.completeInformation.get(taskId!, true)}`);
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        if (resp?.entity) {
          setFormData(deserializeCliModifyCollection(resp.entity.request));
