...
import { summarizeCliFinancingModificationCreation } from '../../../../helpers/mappers/summarizers/summarizeCliFinancingModificationCreation';
import { getErrorMessage } from '../../../../utils/getErrorMessage';
import { RequestDetailsDto } from '../../../../api/types/RequestDetailsDto';
import { serializeCliFinancingModificationCollection } from '../../../../helpers/mappers/serializers/cli/financingModification/serialize';
...
const CompleteInformationForm: React.FC = () => {
  const { t } = useFormTranslation(
    'cli.financingModification.completeInformation',
  );
  ...
  >(
    `${ApiUrls.cli.financingModification.completeInformation.get(
      taskId!,
      true,
    )}`,
  );
  ...
  const onFinishForm = async () => {
    const serializedFormData =
      await serializeCliFinancingModificationCollection(formData);
    ...
    >
      ...
      <StepComponent
        ...
        onSummarizeFormData={(includedSteps) =>
          summarizeCliFinancingModificationCreation(
