...
import { get as mockedRequestResponse } from '../../../../testUtils/mocks/data/cli/financingCancellation/completeInformation';
import * as openNewWindowModule from '../../../../utils/openNewWindow';

describe('Component ViewRequestDetails CliFinancingCancellationDetailedView', () => {
  ...
  const renderWithProps = (props: any = {}) => {
    renderComponentWithToast(
      <CliFinancingCancellationDetailedView {...defaultProps} {...props} />,
    );
  };
