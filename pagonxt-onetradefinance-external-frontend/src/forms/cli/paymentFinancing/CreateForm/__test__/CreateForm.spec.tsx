...
import { get as submitResponse } from '../../../../../testUtils/mocks/data/cli/paymentFinancing/completeInformation';
...
describe('Form CLI PAYMENT FINANCING CreateForm', () => {
  ...
  describe('Draft data operations', () => {
    ...
    const url = ApiUrls.cli.paymentFinancing.create.get(collectionRef);
    ...
    it('updates the files IDs, request code and other data with updated draft save response data', async () => {
      ...
      await waitFor(() =>
        expect(
          fetchMockJest.lastCall(ApiUrls.cli.paymentFinancing.create.saveDraft),
        ).toBeTruthy(),
      );
