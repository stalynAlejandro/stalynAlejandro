...
import { formData } from '../../../../../testUtils/mocks/data/cli/financingRequest/formData';
import { get as submitResponse } from '../../../../../testUtils/mocks/data/cli/financingRequest/completeInformation';
...
describe('Form CLI FINANCING REQUEST CreateForm', () => {
  ...
  describe('Draft data operations', () => {
    ...
    const url = ApiUrls.cli.financingRequest.create.get(collectionRef);
    ...
    it('updates the files IDs, request code and other data with updated draft save response data', async () => {
      ...
      await waitFor(() =>
        expect(
          fetchMockJest.lastCall(ApiUrls.cli.financingRequest.create.saveDraft),
        ).toBeTruthy(),
      );
